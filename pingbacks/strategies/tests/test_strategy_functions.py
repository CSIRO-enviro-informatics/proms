...
def test_send_pingback():
    ...
    r1 = strategy_functions.send_pingback(pingback_test_uri, fake_provenance_uris)[0]

    # test a broken URI
    r2 = not strategy_functions.send_pingback(pingback_test_uri, 'not_a_uri')[0]

    # test empty messages
    r3 = not strategy_functions.send_pingback(pingback_test_uri, [])[0]
    r4 = not strategy_functions.send_pingback(pingback_test_uri, '')[0]
    ...
    r5 = strategy_functions.send_pingback(pingback_test_uri, fake_provenance_uris, further_links_example)[0]
