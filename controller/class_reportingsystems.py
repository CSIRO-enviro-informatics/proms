...
class IncomingReportingSystem(IncomingClass):
    ...
    def valid(self):
        """Validates an incoming ReportingSystem using direct _tests (can it be parsed?) and appropriate RuleSets"""
        ...
        try:
            ...
            print(self.request.data.decode('utf-8'))
    ...
    def _generate_new_uri(self, old_uri):
        ...
        new_uri = conf.REPORTINGSYSTEM_BASE_URI + str(uuid.uuid4())
        self.uri = new_uri
    ...
    def _generate_named_graph_uri(self):
        self.named_graph_uri = conf.REPORTINGSYSTEM_NAMED_GRAPH_BASE_URI + str(uuid.uuid4())
