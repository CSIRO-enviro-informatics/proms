...
from modules.rulesets.reports import BasicReport, ExternalReport, InternalReport
from modules.secure import PromDb
from modules.secure import User
...
#
#   All the controllers in the API
#
...
def registerSignedReport():
        ...
        try:
            ...
            if reporting_system != '':
                rs_dict = model.ReportingSystem.get_reportingsystem(reporting_system)
                if 'v' in rs_dict:
