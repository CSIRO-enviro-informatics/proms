...
def classes():
    return render_template('old/classes.html',
...
def reportingsystem():
    if request.method == 'GET':
        if request.args.get('uri'):
            ...
            return render_template('old/reportingsystem.html',
                                   REPORTINGSYSTEM=rs,
                                   WEB_SUBFOLDER=settings.WEB_SUBFOLDER)
    ...
    if request.method == 'GET':
        ...
        if request.args.get('uri'):
            ...
            if request.args.get('_format'):
                ...
                '''
                return render_template('old/report.html',
                                       REPORT=report,
                                       PROMS_INSTANCE_NAMESPACE_URI=settings.BASE_URI,
                                       WEB_SUBFOLDER=settings.WEB_SUBFOLDER)
...
def entities():
    ...
    if request.args.get('uri'):
        ...
        if request.args.get('_format'):
            ...
            return render_template('old/entity.html',
                                   ENTITY=entity,
                                   WEB_SUBFOLDER=settings.WEB_SUBFOLDER)
...
def activities():
    ...
    if request.args.get('uri'):
        ...
        if request.args.get('_format'):
            ...
            return render_template('old/activity.html',
                                   PROMS_INSTANCE_NAMESPACE_URI=settings.BASE_URI,
                                   ACTIVITY=activity,
                                   WEB_SUBFOLDER=settings.WEB_SUBFOLDER)
...
def agents():
    ...
    if request.args.get('uri'):
        ...
        if request.args.get('_format'):
            ...
            return render_template('old/agent.html',
                                   AGENT=agent,
                                   WEB_SUBFOLDER=settings.WEB_SUBFOLDER)
